...
const addData = async (req, res) => {
	try {
		...
		const facilities = { facilities1, facilities2, facilities3 };
...
const updateData = async (req, res) => {
	try {
		...
		facilities1 = facilities1 || findData.rows[0].facilities[0];
		facilities2 = facilities2 || findData.rows[0].facilities[1];
		facilities3 = facilities3 || findData.rows[0].facilities[2];
		...
		if (facilities1 || facilities2 || facilities3) {
			facilities = { facilities1, facilities2, facilities3 };
		}

		facilities = JSON.stringify(facilities);

		const updatedData = { airline_code, airline_name, class_category, class_category, price_adult, price_child, facilities, refundable, reschedulable, airline_image };
